...
{
  "$end", "error", "$undefined", "NOME", "DATA", "TELEMOVEL", "EMAIL",
  "TIPOCONTACTO", "NOTAS", "$accept", "start", "complete", "pfrase",
  "repnotas", YY_NULLPTR
};
#endif
...
{
       2,     3,     9,     4,    10,     7,     8,    15,    16,    11,
      14,    12,    13
};

static const yytype_int8 yycheck[] =
{
       0,     1,     5,     3,     6,     4,     5,    12,    13,     6,
       8,     7,     7
};
...
#line 1313 "Ex1.tab.c"
  ...
  case 6:
#line 27 "Ex1.y"
                                                        {printNome(yyvsp[-5]);printEmailAndContacto(yyvsp[-2],yyvsp[-3]);printTipoDeContacto(yyvsp[-1]);increaseContactos(yyvsp[-1]);}
#line 1319 "Ex1.tab.c"
    break;

  case 7:
#line 28 "Ex1.y"
                                                       {printNome(yyvsp[-4]);printEmailAndContacto(yyvsp[-2],yyvsp[-3]);printTipoDeContacto(yyvsp[-1]);increaseContactos(yyvsp[-1]);}
#line 1325 "Ex1.tab.c"
    break;
